            ...
            <div className="flex gap-2">
                {['X', 'Y', 'Z'].map((axis, i) => (
                    <div key={axis} className="relative flex-1 group">
                        <div className={`absolute left-2 top-1.5 text-[9px] font-bold pointer-events-none ${
    ...
    <div className="flex flex-col h-full text-zinc-300 select-none bg-[#18181b]">
      ...
      <div className="flex-1 flex flex-col min-h-0 border-b border-white/5">
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[#18181b]">
             ...
             <button onClick={addLightToScene} className="w-5 h-5 rounded bg-[#27272a] hover:bg-zinc-700 border border-white/5 text-zinc-400 hover:text-white flex items-center justify-center transition-all" title="Add Light">
                 <Plus size={12} />
             </button>
          </div>
                        ...
                        <div>
                            {activeCameraId === selectedObject.id ? (
                                <button 
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-2 bg-zinc-800 text-zinc-300 rounded-lg text-xs font-bold hover:bg-zinc-700 transition border border-white/5"
                                >
                                ...
                                <button 
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-900/20"
                                >
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    ...
                    <div className="flex items-center justify-between p-4 bg-[#09090b] rounded-lg border border-white/5">
                        ...
                        <input 
                            ...
                            className="w-5 h-5 rounded bg-zinc-800 border-zinc-700 accent-indigo-500 cursor-pointer"
                        />
                    </div>
                </div>
            )}
            ...
            {selectedObjectId === 'camera' && (
                <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    ...
                    <div className="pt-4 border-t border-white/5">
                        <button 
                            onClick={resetCamera}
                            className="w-full bg-[#09090b] border border-white/10 hover:bg-[#27272a] text-zinc-400 hover:text-zinc-200 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all"
                        >
